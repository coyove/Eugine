 ...
 */
public class PBitXor extends SExpression {
    @ReplaceableVariable
    ...
    public PBitXor(Atom ha, SExpression left, SExpression right) {
        atom = ha;
        this.left = left;
        this.right = right;
    }

    public PBitXor(Atom ha, SExpression l, SExpression r, boolean a) {
        this(ha, l, r);
        assign = a;
    }
