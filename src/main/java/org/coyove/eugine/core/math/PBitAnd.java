 ...
 */
public class PBitAnd extends SExpression {
    @ReplaceableVariable
    ...
    public PBitAnd(Atom ha, SExpression left, SExpression right) {
        atom = ha;
        this.left = left;
        this.right = right;
    }

    public PBitAnd(Atom ha, SExpression l, SExpression r, boolean a) {
        this(ha, l, r);
        assign = a;
    }
